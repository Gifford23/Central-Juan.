...
const PagibigContributionTable = () => {
  ...
  const fetchContributions = () => {
    setLoading(true);
    fetch(`${BASE_URL}/contributions/pagibig/table/pagibig_contribution_table.php`)
  ...
  return (
    <div className="container">
      {/* <h2 className="text-2xl font-bold mb-4">Pagibig Contributions Table</h2> */}
      <div className="flex flex-col gap-y-2  w-full pb-3 Glc-dashboard-bg-header border-b-2 pl-5 sticky mb-5">
        <span className='text-2xl font-semibold'>Pagibig Contributions Table</span>
...
export default PagibigContributionTable;
