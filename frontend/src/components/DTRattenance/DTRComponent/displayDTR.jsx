  ...
  return (
    <div style={containerStyle} aria-live="polite">
      ...
      <div className="desktop-wrapper" style={{ display: 'none' }}>
        ...
        {allDates.map((currentDate, i) => {
          ...
          return (
            <div key={dateKey} style={{ ...desktopRowStyle, ...rowBg }}>
              ...
              <div style={{ textAlign: 'right', color: rec ? '#111827' : '#6b7280', fontWeight: 600 }}>
        ...
        <div style={{ ...desktopRowStyle, background: '#f9fafb', fontWeight: 700 }}>
          <div style={{ gridColumn: '1 / span 4', textAlign: 'right', paddingRight: 12 }}>Total Rendered Hours:</div>
          <div style={{ textAlign: 'right', color: '#4f46e5' }}>{totalRenderedSum.toFixed(2)}</div>
        </div>
      </div>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ fontSize: 12, color: '#6b7280', marginTop: 6 }}>Rendered</div>
                  <div style={{ fontWeight: 700, color: rec ? '#111827' : '#6b7280' }}>
                    {rec ? (rec.total_rendered_hours ?? '0.00') : '0.00'}
                  </div>
                </div>
              </div>
