...
// PHILHEALH CONTRIBUTIONS http://10.0.254.104/central_juan/backend/contributions/philhealth/philhealth_contribution.php
$sql = "SELECT * FROM philhealth_contribution"; // SQL query to select all records from the payroll table
