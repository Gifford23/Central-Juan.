...
// SSS contributions http://10.0.254.104/central_juan/backend/contributions/sss/sss_contribution.php
$sql = "SELECT * FROM sss_contribution"; // SQL query to select all records from the payroll table
