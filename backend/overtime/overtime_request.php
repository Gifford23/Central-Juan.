...
<?php
//https://hris.centraljuan.com/central_juan/backend/overtime/overtime_request.php
...
$sql = "SELECT * FROM employee_overtime_request"; // SQL query to select all records from the payroll table
