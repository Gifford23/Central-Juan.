...
//http://localhost/central_juan/backend/philippine_holidays/philippine_holidays.php
...
$sql = "SELECT * FROM philippine_holidays"; // SQL query to select all records from the attendance table
