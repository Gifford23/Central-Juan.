...
try {
    ...
    $stmt = $conn->prepare("SELECT id, commission_id, `date`, amount, created_at FROM commission_daily WHERE commission_id = ? ORDER BY `date` ASC, id ASC");
